...
// const PurchasesModal = ({ data, onClose, onViewItems }) => {
...
//     (acc, purchase) => {
//       acc.totalGST += parseFloat(purchase.gst_amount || 0);
//       acc.totalAmount += parseFloat(purchase.total_amount || 0);
//       acc.totalTransport += parseFloat(purchase.transport || 0);
//       return acc;
//     },
...
//             <h3 className="text-lg font-semibold">Purchases Details</h3>
//             <button
//               onClick={onClose}
...
//                       </td>
//                       <td className="px-4 py-3 text-sm">
//                         {formatCurrency(purchase.transport || 0)}
//                       </td>
//                       <td className="px-4 py-3">
//                         <button
//                           onClick={() => onViewItems(purchase, "purchases")}
...
//               Showing {data.length} purchases entries
//             </div>
//           </div>
//         </div>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {data.map((purchase, index) => (
                    <tr key={index} className="hover:bg-gray-50">
                      <td className="px-4 py-3 text-sm">
                        {formatDateToDDMMYYYY(purchase.bill_date)}
                      </td>
                      <td className="px-4 py-3 text-sm capitalize">
                        {purchase.party_type}
                      </td>
